...
class ExperimentMultiple(ExperimentSingle):
    ...
    def show(self):
        ...
        plt.figure()
        plt.plot(p, self.arr_cc, color="lightcoral", marker="o", linestyle="--", label="关键链法")
        plt.plot(p, self.arr_gm, color="lightskyblue", marker="o", linestyle="--", label="本文方法")
        plt.plot(p, self.arr_sp, color="orange", marker="o", linestyle="--", label="静态三分法")
        plt.plot(p, self.arr_rp, color="lightgreen", marker="o", linestyle="--", label="相对监控法")
        plt.plot(p, self.arr_dp, color="violet", marker="o", linestyle="--", label="动态监控法")
        plt.legend()
        plt.grid(True)
        plt.xlabel("频数")
        plt.ylabel("工期")
