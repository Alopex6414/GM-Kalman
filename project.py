...
if __name__ == '__main__':
    ...
    chain1 = Chain(activeA)
    chain1.append(activeB)
    chain1.append(activeD)
    chain1.append(activeF)
    chain1.append(activeH)
    # chain1.append(activeKM)
    chain1.append(activeK)
    chain1.append(activeM)
    # chain1.append(activeNOP)
    chain1.append(activeN)
    chain1.append(activeO)
    chain1.append(activeP)
    # chain 2 (critical chain)
    # chain2 = Chain(activeABCF)
    chain2 = Chain(activeA)
    chain2.append(activeB)
    chain2.append(activeC)
    chain2.append(activeF)
    chain2.append(activeG)
    # chain2.append(activeJM)
    chain2.append(activeJ)
    chain2.append(activeM)
    # chain2.append(activeNOP)
    chain2.append(activeN)
    chain2.append(activeO)
    chain2.append(activeP)
    # chain 3
    # chain3 = Chain(activeABEF)
    chain3 = Chain(activeA)
    chain3.append(activeB)
    chain3.append(activeE)
    chain3.append(activeF)
    chain3.append(activeI)
    # chain3.append(activeLM)
    chain3.append(activeL)
    chain3.append(activeM)
    # chain3.append(activeNOP)
    chain3.append(activeN)
    chain3.append(activeO)
    chain3.append(activeP)
    # project 1
    project1 = Project()
