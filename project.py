...
if __name__ == '__main__':
    # Project Activities
    activeA = Active(3, 1, 0.06, 8, 2)
    activeB = Active(1, 0.5, 0.02, 4, 1)
    activeC = Active(3, 1, 0.06, 8, 2)
    activeD = Active(2, 0.5, 0.04, 5, 2)
    activeE = Active(2, 0.5, 0.04, 5, 2)
    activeF = Active(1, 0.5, 0.02, 4, 1)
    activeG = Active(21, 7, 0.42, 56, 14)
    activeH = Active(15, 5, 0.3, 40, 10)
    activeI = Active(18, 6, 0.36, 48, 12)
    activeJ = Active(9, 3, 0.18, 24, 6)
    activeK = Active(5, 1.5, 0.1, 13, 4)
    activeL = Active(6, 2, 0.12, 16, 4)
    activeM = Active(1, 0, 0.02, 1, 1)
    activeN = Active(3, 2, 0.06, 13, 1)
    activeO = Active(2, 1, 0.04, 7, 1)
    activeP = Active(1, 0, 0.02, 1, 1)
    # Combine Activities
    activeABDF = Active(7, 3, 0.14, 22, 4)
    activeABCF = Active(8, 3, 0.16, 23, 5)
    activeABEF = Active(7, 3, 0.14, 22, 4)
    activeKM = Active(6, 5, 0.12, 31, 1)
    activeJM = Active(10, 3, 0.2, 25, 7)
    activeLM = Active(7, 5, 0.14, 32, 2)
    activeNOP = Active(6, 3, 0.12, 21, 3)
    # chain1
