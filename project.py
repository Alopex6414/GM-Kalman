...
if __name__ == '__main__':
    # Project Activities
    activeA = Active(3, 1, 0.02, 8, 3)
    activeB = Active(1, 0.5, 0.01, 4, 1)
    activeC = Active(3, 1, 0.03, 8, 3)
    activeD = Active(2, 0.5, 0.02, 5, 2)
    activeE = Active(2, 0.5, 0.02, 5, 2)
    activeF = Active(1, 0.5, 0.01, 4, 1)
    activeG = Active(21, 7, 0.14, 56, 21)
    activeH = Active(15, 5, 0.1, 40, 15)
    activeI = Active(18, 6, 0.12, 48, 18)
    activeJ = Active(9, 3, 0.06, 24, 9)
    activeK = Active(5, 1.5, 0.03, 13, 5)
    activeL = Active(6, 2, 0.04, 16, 6)
    activeM = Active(1, 0, 0.01, 1, 1)
    activeN = Active(3, 2, 0.02, 13, 3)
    activeO = Active(2, 1, 0.01, 7, 2)
    activeP = Active(1, 0, 0.01, 1, 1)
    # Combine Activities
    activeABDF = Active(7, 3, 0.04, 22, 7)
    activeABCF = Active(8, 3, 0.06, 23, 8)
    activeABEF = Active(7, 3, 0.05, 22, 7)
    activeKM = Active(6, 5, 0.04, 31, 6)
    activeJM = Active(10, 3, 0.07, 25, 10)
    activeLM = Active(7, 5, 0.05, 32, 7)
    activeNOP = Active(6, 3, 0.04, 21, 6)
    # chain1
