...
if __name__ == '__main__':
    # Project Activities
    activeA = Active(3, 1, 0.05, 8, 3)
    activeB = Active(1, 0.5, 0.02, 4, 1)
    activeC = Active(3, 1, 0.06, 8, 3)
    activeD = Active(2, 0.5, 0.04, 5, 2)
    activeE = Active(2, 0.5, 0.04, 5, 2)
    activeF = Active(1, 0.5, 0.02, 4, 1)
    activeG = Active(21, 7, 0.28, 56, 21)
    activeH = Active(15, 5, 0.2, 40, 15)
    activeI = Active(18, 6, 0.24, 48, 18)
    activeJ = Active(9, 3, 0.12, 24, 9)
    activeK = Active(5, 1.5, 0.06, 13, 5)
    activeL = Active(6, 2, 0.08, 16, 6)
    activeM = Active(1, 0, 0.02, 1, 1)
    activeN = Active(3, 2, 0.04, 13, 3)
    activeO = Active(2, 1, 0.02, 7, 2)
    activeP = Active(1, 0, 0.02, 1, 1)
    # Combine Activities
    activeABDF = Active(7, 3, 0.08, 22, 7)
    activeABCF = Active(8, 3, 0.12, 23, 8)
    activeABEF = Active(7, 3, 0.1, 22, 7)
    activeKM = Active(6, 5, 0.08, 31, 6)
    activeJM = Active(10, 3, 0.14, 25, 10)
    activeLM = Active(7, 5, 0.1, 32, 7)
    activeNOP = Active(6, 3, 0.08, 21, 6)
    # chain1
